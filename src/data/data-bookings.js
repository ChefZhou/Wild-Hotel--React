...
export const bookings = [
  // CABIN 001
  {
    ...
    hasBreakfast: true,
    observations:
      "我們會帶著我們的小狗一起來，希望你們能提供一個寵物友好的房間",
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  // CABIN 006
  {
    ...
    guestId: 17,
    hasBreakfast: false,
    observations: "我們也許會提前到達，所以如果可能的話，我們希望能提前入住",
    isPaid: true,
    numGuests: 6,
  },
  {
  ...
  // CABIN 008
  {
    ...
    hasBreakfast: true,
    observations:
      "我家人是素食主義者，所以我們需要素食早餐。請確保房間是素食友好的",
    isPaid: true,
    numGuests: 9,
  },
  {
    ...
    hasBreakfast: true,
    observations:
      "我想慶祝我的生日，所以我們會有一些朋友一起來。我們需要一個大一點的房間",
    isPaid: true,
    numGuests: 10,
  },
  {
